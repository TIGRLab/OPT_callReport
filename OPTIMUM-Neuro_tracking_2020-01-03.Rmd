---
title: "OPTIMUM-Neuro conference call 2020-02-07"
...
source('functions_december.R')

#read in data
  df <- read.csv('//home/gherman/Downloads/OPTIMUMMainDatabaseF_DATA_2020-02-06_1535.csv', na.strings=c("","NA")) #contains all but MRI
  mri <- read.csv('/home/gherman/Downloads/OPTIMUMMainDatabaseF_DATA_2020-02-06_1534.csv', na.strings=c("","NA")) #contains just MRI
...
```
>We are currently in month `r targets[targets$month == as.character(substr("2019-12-31", 1, 7)), 'month_count']` of the study.  
