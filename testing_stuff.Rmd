...
expected_current_mo <- sum(filtered_fu_df$mri_fu_mthT) #WAIT THIS SHOULD BE CHANGED TO MONTH #also do i want to share the number of expected that have been completed in other months? very confusing overall. 
