...
prepare_recruit_df <- function(recruit_df){
  ...
  recruit_df$currentYm <- "2019-08-31" #add current sysdate to df
...
prepare_enroll_df <- function(enroll_df) {
  ...
  enroll_df$mri_fu_due <-  ifelse(enroll_df$enroll_mri_date %m+% months(6) < "2019-08-31", 1, 0) #why was this   enroll_df$mri_fu_due <-  ifelse(enroll_df$enroll_mri_date %m+% months(6) < "2019-07-31", 1, 0)
  enroll_df$mri_fu_7_mos <-  ifelse(enroll_df$enroll_mri_date %m+% months(7) < "2019-08-31", 1, 0)
  ...
  enroll_df$bld_fu_due <-  ifelse(enroll_df$enroll_bld_date %m+% months(6) < "2019-08-31", 1, 0)
  enroll_df$bld_fu_7_mos <-  ifelse(enroll_df$enroll_bld_date %m+% months(7) < "2019-08-31", 1, 0) 
  ...
  enroll_df$np_fu_due <-  ifelse(enroll_df$enroll_np_date %m+% months(6) < "2019-08-31", 1, 0)
  enroll_df$np_fu_7_mos <-  ifelse(enroll_df$enroll_np_date %m+% months(7) <"2019-08-31", 1, 0)
...
prep_fu_df <- function(fu_df){
  ...
  fu_df$currentYm <- "2019-08-31" #add current sysdate to df
...
make_enroll_table <- function(recruit_df, sites, targets){
  ...
  for (site in sites) {
    ...
    d = targets[targets$month == as.character(substr("2019-08-31", 1, 7)), 'per_month']
  ...
  for (site in sites) {
    ...
    d = targets[targets$month == as.character(substr("2019-08-31", 1, 7)), 'target']
