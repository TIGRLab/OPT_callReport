...
#read in data
  df <- read.csv('/scratch/gherman/OPTIMUMMainDatabaseF_DATA_2019-04-24_1113.csv', na.strings=c("","NA")) #contains all but MRI
  mri <- read.csv('/scratch/gherman/OPTIMUMMainDatabaseF_DATA_2019-04-24_1114.csv', na.strings=c("","NA")) #contains just MRI
