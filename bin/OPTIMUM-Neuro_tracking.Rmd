---
title: "OPTIMUM-Neuro conference call 2021-01-22"
...
source('functions.R')
#read in data
  mri <- read.csv('../sources/OPTIMUM_2021_01_21_Neuro.csv',na.strings=c("","NA")) #contains all but MRI
  df <- read.csv('../sources/OPTIMUM_2021_01_21_Demo.csv', na.strings=c("","NA")) #contains just MRI
