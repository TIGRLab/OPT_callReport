---
title: "OPTIMUM-Neuro conference call 2020-09-17"
...
source('functions.R')
#read in data
  mri <- read.csv('../sources/OPTIMUM_2020-09-17_Neuro.csv',na.strings=c("","NA")) #contains all but MRI
  df <- read.csv('../sources/OPTIMUM_2020-09-17_Demo.csv', na.strings=c("","NA")) #contains just MRI
