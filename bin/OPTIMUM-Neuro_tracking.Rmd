---
title: "OPTIMUM-Neuro conference call 2020-10-02"
...
source('functions.R')
#read in data
  mri <- read.csv('../sources/OPTIMUM_Neuro.csv',na.strings=c("","NA")) #contains all but MRI
  df <- read.csv('../sources/OPTIMUM_Demo.csv', na.strings=c("","NA")) #contains just MRI
