---
title: "OPTIMUM-Neuro conference call 2020-11-06"
...
source('functions.R')
#read in data
  mri <- read.csv('../sources/OPTIMUM_2020-11-05_Neuro.csv',na.strings=c("","NA")) #contains all but MRI
  df <- read.csv('../sources/OPTIMUM_2020-11-05_Demo.csv', na.strings=c("","NA")) #contains just MRI
