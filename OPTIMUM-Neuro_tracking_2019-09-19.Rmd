---
title: "OPTIMUM-Neuro conference call 2019-09-19"
...
#read in data
  df <- read.csv('/home/gherman/Downloads/OPTIMUMMainDatabaseF_DATA_2019-09-19_1021.csv', na.strings=c("","NA")) #contains all but MRI
  mri <- read.csv('/home/gherman/Downloads/OPTIMUMMainDatabaseF_DATA_2019-09-19_1020.csv', na.strings=c("","NA")) #contains just MRI
...
```
>We are currently in month `r targets[targets$month == as.character(substr("2019-08-05", 1, 7)), 'month_count']` of the study.  
