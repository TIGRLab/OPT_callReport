...
# load graphics libraries
    ...
    setwd('/scratch/gherman/OPT_callReport')
...
#read in data
  df <- read.csv('/home/gherman/Downloads/OPTIMUMMainDatabaseF_DATA_2019-02-14_1042.csv', na.strings=c("","NA")) #contains all but MRI
  mri <- read.csv('/home/gherman/Downloads/OPTIMUMMainDatabaseF_DATA_2019-02-14_1041.csv', na.strings=c("","NA")) #contains just MRI
