...
#read in data
  df <- read.csv('/projects/gherman/OPT_callreport/data/OPTIMUMMainDatabaseF_DATA_2019-04-02_1414.csv', na.strings=c("","NA")) #contains all but MRI
  mri <- read.csv('/projects/gherman/OPT_callreport/data/OPTIMUMMainDatabaseF_DATA_2019-04-02_1145.csv', na.strings=c("","NA")) #contains just MRI
...
fu_df <- recruit_df %>% filter(.,timepoint=="6 mth FU")
...
#first, check if T1 complete, and if date is this month
  ...
  fu_df$enroll_mri_mthT <- fu_df$enroll_mri_mth %in% fu_df$currentYm_str #logical T or F- was MRI this month?
